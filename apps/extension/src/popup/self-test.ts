import type { UmtActivateSiteResponse, UmtContentCommand, UmtDirectHttpRequest, UmtDirectHttpResponse, UmtPageSampleSelfTestResponse } from "../content/messages.js";
