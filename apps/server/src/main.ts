...
const app = await buildServer({ provider: config.provider, targetLanguage: config.targetLanguage, visionProvider, surfaceCache, eventBus, maxImageLongEdge: config.maxImageLongEdge, jpegQuality: config.jpegQuality });
