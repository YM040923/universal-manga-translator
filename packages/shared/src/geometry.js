export function mapNaturalBoxToRenderedBox(box, naturalSize, renderedRect) {
...
export function area(rect) { return Math.max(0, rect.width) * Math.max(0, rect.height); }
export function visibleRatio(subject, viewport) {
